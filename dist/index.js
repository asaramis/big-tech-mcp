...
import { initializeIndex, searchTranscripts, getEpisode, listEpisodes, getRecentEpisodes, } from "./search.js";
        ...
        tools: [
            {
                ...
                description: "Search across all Big Technology Podcast transcripts for tech insights and news. " +
                ...
                inputSchema: {
                    ...
                    properties: {
                        query: {
                            type: "string",
                            description: "The search query - use keywords related to the tech topic you want insights on",
                        },
                        limit: {
                            type: "number",
            ...
            {
                name: "get_episode",
                description: "Get the full transcript for a specific episode by title. " +
                ...
                inputSchema: {
                    ...
                    properties: {
                        title: {
                            type: "string",
                            description: "The episode title or partial title (e.g., 'Mark Warner', 'OpenAI')",
                        },
                    },
                    required: ["title"],
                },
            ...
            {
                name: "list_episodes",
                description: "List all available episodes in the Big Technology Podcast archive. " +
            ...
            },
            {
                ...
                description: "Get the most recent episodes from the Big Technology Podcast. " +
                ...
                case "get_episode": {
                    ...
                    if (!episode) {
                        ...
                        const suggestions = allEpisodes
                            .filter((e) => e.toLowerCase().includes(title.toLowerCase().split(" ")[0]))
                            .slice(0, 5);
                        return {
                            content: [
                                {
                                    type: "text",
                                    text: `Episode with title "${title}" not found.${suggestions.length > 0
